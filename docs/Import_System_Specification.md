...
## GP-005 Multi-Tab Sub-Screen Workspace (نظام الشاشات المتعددة والتبويبات الفرعية)

Purpose

يسمح النظام بفتح ملفات الاستيراد والسجلات والمستندات المختلفة في شاشات فرعية تبوبية (Sub-Screens / Multi-Tabs) داخل بيئة العمل الرئيسية، مما يتيح للمستخدم العمل على أكثر من ملف استيراد أو مورد في نفس الوقت والانتقال بينهم بسهولة دون إغلاق الشاشة أو فقدان البيانات المدخلة.

Rules

1. عند الضغط على أي ملف استيراد (مثل IMP-2026-0001) أو سجل مورد، يتم فتحه في تبويب فرعي جديد (Sub-Tab).
2. يحتوي كل تبويب فرعي على زر إغلاق (✕) وتقتصر التبويبات المفتوحة في نفس الوقت على 10 تبويبات كحد أقصى.
3. عند محاولة فتح ملف مفتوح بالفعل، يقوم النظام بالانتقال التلقائي للتبويب المفتوح بدلاً من تكراره.
4. يتيح مفتاح الاختصار `Ctrl+W` إغلاق التبويب الفرعي الحالي.
...
قد تؤدى إلى رفض طلب ACID أو تأخير إجراءات التخليص الجمركى.
